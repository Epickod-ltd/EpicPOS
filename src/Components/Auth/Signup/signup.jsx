...
const SignUpPage = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-screen bg-gray-100 overflow-y-scroll">
            <div className="flex flex-grow">
                {/* Left side: Sign Up Form */}
                <div className="w-full md:w-1/3 flex flex-col justify-start items-start px-8 bg-white shadow-lg">
                    {/* Logo Section */}
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="/login" className="text-[#2D72B4] hover:underline">
                                Log in here
                            </a>
                        </p>
                    </div>
